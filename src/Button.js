...
<h1 className={!button ? "hidden" :"block"}>Do you want to mark this as an Urgent Job ?</h1> 

<h1 className={!button ? "block" :"hidden"} >Mark this as Urgent (Please specify your next steps)</h1>
