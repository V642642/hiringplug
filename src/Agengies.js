...
Serving Skill Pvt Ltd Test</h4>
<span className="">
<h4>Industries</h4>
<h5 className=" w-full lg:w-10/12 text-gray-500 ">banking,Financial Svcs. (Non-bank & Insurance),Information Technology,Investments & Asset Management,Management Consulting,</h5>
</span>
<div className="exp">
<h4>Experience</h4>
...
<span className="">GST: 27AFGPG8635Q1ZR) Nurtured and conceptualised by Preity Goyyal, a Chartered Accountant and M.Phil. Our mission is to serve skills to cater for Human Resource needs of different industries. We serve our purpose with strong database and analytical skills to identify right candidate to fit in the work environment. We offer our expertise by screening the candidate through technical, communication, reliability, stability and economical parameters. Nurtured and conceptualised by Preity Goyyal, a Chartered Accountant and M.Phil. Our mission is to serve skills to cater for Human Resource needs of different industries. We serve our purpose with strong database and analytical skills to identify right candidate to fit in the work environment. We offer our expertise by screening the candidate through technical, communication, reliability, stability and economical parameters.</span>
</div>
